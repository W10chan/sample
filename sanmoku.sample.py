...
def syouhai():
    ...
    if kachi == 1:
        ...
        cvs.create_text(300, 300, text="あなたの勝ち！", font=FNT, fill="black")

        shirushi = 9

    if kachi == 2:

        cvs.create_text(300, 300, text="残念！コンピュータ\nの勝ち〜", font=FNT, fill="black")

        shirushi = 9

    if kachi == 0 and shirushi == 9:

        cvs.create_text(300, 300, text="引き分け", font=FNT, fill="black")
